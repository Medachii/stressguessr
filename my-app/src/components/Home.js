...
const Home = () => {
    return (
        <div>
            ...
            <p>On this website, you can find a <a href='http://localhost:3000/dictionary'>dictionary</a> that explains a bit of how to read the phonetic writing of words, and the true <a href='http://localhost:3000/dictionary'>game</a> part, powered by our own phonetics-written language translation algorithm.</p>
        </div>
    );
}
